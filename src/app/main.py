...
albums = [ 
    ...
    Album(8, "Seven Revision Army", "The Blue-Green Stripes", 13.99, "https://aka.ms/albums-containerappslogo"),
    Album(9, "Scale It Up", "KEDA Club", 13.99, "https://aka.ms/albums-kedalogo"),
    Album(10, "New Moview", "KEDA", 20.11, "https://"),
    Album(11, "New Moview", "KEDA", 20.11, "https://new")
]
